...
def pre_save_organizationcategory(
...
def post_save_organizationcategory(
...
def m2m_changed_organizationcategory(
...
def post_save_organizationtype(
    sender, instance, created, raw, using, update_fields, **kwargs
):
    pass
...
def m2m_changed_organizationtype(
    sender, instance, action, reverse, model, pk_set, using, **kwargs
):
    pass
