...
class EmployeeService(EmployeeServiceBase):
    ...
    def __create_employee(self):
        ...
        if len(employee) == 0:
            employee = Employee(
                name=employee_name, email=employee_email, organization=self.organization
            )
            employee.save()
    ...
    def __academic_degree(self):
        ...
        self.employee_knowledge = EmployeeKnowledge(
    ...
    def __knowledge_level(self):
        for line in range(17, 21):
            ...
            sth_stage_knwoledge_level = SthStageKnwoledgeLevel(
                stage=stage,
                knwoledge_level=knwoledge_level,
                employee_knowledge=self.employee_knowledge,
            )
    ...
    def __experience_level(self):
        for line in range(24, 28):
            ...
            sth_stage_knwoledge_level = SthStageExperienceLevel(
                stage=stage,
...
class EmployeenGoogleFormsService(EmployeeServiceBase):
    ...
    def __create_experience_level(self, sth_level, experience_level):
        sth_experience_level_level = SthStageExperienceLevel(
            stage=sth_level, experience_level=experience_level, employee=self.employee
        )
    ...
    def __create_knowledge_level(self, sth_level, knwoledge_level):
        sth_stage_knwoledge_level = SthStageKnwoledgeLevel(
            stage=sth_level, knwoledge_level=knwoledge_level, employee=self.employee
        )
