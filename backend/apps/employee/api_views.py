...
from .serializers import (
    AcademicDegreeCategoryReadSerializer,
    AcademicDegreeCategoryWriteSerializer,
    AcademicDegreeReadSerializer,
    AcademicDegreeWriteSerializer,
    AcademicDegreeStatusReadSerializer,
    AcademicDegreeStatusWriteSerializer,
    KnwoledgeLevelReadSerializer,
    KnwoledgeLevelWriteSerializer,
    ExperienceLevelReadSerializer,
    ExperienceLevelWriteSerializer,
    PositionReadSerializer,
    PositionWriteSerializer,
    EmployeeReadSerializer,
    EmployeeWriteSerializer,
    EmployeeKnowledgeReadSerializer,
    EmployeeKnowledgeWriteSerializer,
    SthStageKnwoledgeLevelReadSerializer,
    SthStageKnwoledgeLevelWriteSerializer,
    SthStageExperienceLevelReadSerializer,
    SthStageExperienceLevelWriteSerializer,
    TeamReadSerializer,
    TeamWriteSerializer,
)
