...
class AcademicDegree(Base):
    ...
    academic_degree_category = models.ForeignKey(
        AcademicDegreeCategory,
        blank=True,
        null=True,
        on_delete=models.CASCADE,
        related_name="academic_degree_category_%(class)s",
    )
...
class Employee(Base):
    ...
    employee_position = models.ForeignKey(
        ...
        null=True,
        on_delete=models.CASCADE,
        related_name="position_%(class)s",
    )
    employee_organization = models.ForeignKey(
        "apps_organization.Organization",
        blank=True,
        null=True,
        on_delete=models.CASCADE,
        related_name="employee_organization_%(class)s",
    )
...
class EmployeeKnowledge(Historical):
    ...
    academic_degree = models.ForeignKey(
        ...
        null=True,
        on_delete=models.CASCADE,
        related_name="academic_degree_%(class)s",
    )
    academic_degree_status = models.ForeignKey(
        AcademicDegreeStatus,
        blank=True,
        null=True,
        on_delete=models.CASCADE,
        related_name="academic_degree_status_%(class)s",
    )
    employee = models.ForeignKey(
        ...
        null=True,
        on_delete=models.CASCADE,
        related_name="employee_%(class)s",
    )
...
class SthStageKnwoledgeLevel(Historical):
    ...
    stage = models.ForeignKey(
        ...
        null=True,
        on_delete=models.CASCADE,
        related_name="stage_%(class)s",
    )
    Knwoledge_level = models.ForeignKey(
        KnwoledgeLevel,
        blank=True,
        null=True,
        on_delete=models.CASCADE,
        related_name="knwoledge_level_%(class)s",
    )
    employee = models.ForeignKey(
        Employee,
        blank=True,
...
class SthStageExperienceLevel(Base):
    stage_experience_level = models.ForeignKey(
        "apps_sth.Stage", on_delete=models.CASCADE, help_text="employee's knowledge"
    )
    experience_level = models.ForeignKey(
        ExperienceLevel, on_delete=models.CASCADE, help_text="employee's knowledge"
    )
    employee_experience_level = models.ForeignKey(
        Employee,
        on_delete=models.CASCADE,
        help_text="employee's knowledge",
...
class Team(Base):
    ...
    organization_team = models.ForeignKey(
        Organization, on_delete=models.CASCADE, help_text="organization"
    )
    responsible = models.ForeignKey(
        Employee, on_delete=models.CASCADE, help_text="Employee"
    )
