...
from .models import Statement, AdoptedLevel, Answer
import xlrd
from apps.organization.services import (
    OrganizationService,
    OrganizationGoogleFormsService,
)
    ...
    def __assertives(self, sheet_id):
        ...
        for line in range(6, sheet.nrows):
            ...
            if code in self.statements:
                ...
                answer = Answer(
                    questionnaire=self.questionnarie,
...
class QuestionnaireGoogleFormsService:
    ...
    def process_data(self, instance):
        ...
        for line in range(1, self.sheet.nrows):
            organization = self.organization_service.process_data(
                self.sheet, instance, line
            )
