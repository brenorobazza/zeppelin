...
class Statement(Base):
    ...
    continuous_activity = models.ForeignKey(
        ContinuousActivity,
        on_delete=models.CASCADE,
        null=True,
        blank=True,
...
class QuestionnaireExcel(Questionnaire):
    feedback_questionnaire = models.ForeignKey(
        FeedbackQuestionnaire, on_delete=models.CASCADE, null=True, blank=True
    )
