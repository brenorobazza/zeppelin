...
router.register(
    r"academicdegreecategory",
    AcademicDegreeCategoryViewSet,
    basename="academicdegreecategory",
)
router.register(r"academicdegree", AcademicDegreeViewSet, basename="academicdegree")
router.register(
    r"academicdegreestatus",
    AcademicDegreeStatusViewSet,
    basename="academicdegreestatus",
)
...
router.register(
    r"employeeknowledge", EmployeeKnowledgeViewSet, basename="employeeknowledge"
)
router.register(
    r"sthstageknwoledgelevel",
    SthStageKnwoledgeLevelViewSet,
    basename="sthstageknwoledgelevel",
)
router.register(
    r"sthstageexperiencelevel",
    SthStageExperienceLevelViewSet,
    basename="sthstageexperiencelevel",
)
